...
const broadcastDoc = read("broadcasts/broadcast-schedule-2026.json");
const broadcastByGame = {};
for (const assignment of broadcastDoc.assignments) {
  if (!assignment.matched_game_id) continue;
  if (!broadcastByGame[assignment.matched_game_id]) {
    broadcastByGame[assignment.matched_game_id] = {
      tv: assignment.tv ?? null,
